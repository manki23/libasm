...
_ft_strdup:
            call	_ft_strlen	; Call `ft_strlen` to get the length of the source string => rax = len of rdi
            ...
            call	_malloc		; Allocate rdi memory for the duplicate string. Pointer returned in `rax`.
            ...
            call	_ft_strcpy  ; Call `ft_strcpy(rdi, rsi)` to copy the source string into the allocated memory.
